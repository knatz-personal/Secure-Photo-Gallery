...
namespace WebPortal
{
    ...
    {
        public AppRoleManager(IRoleStore<AspNetRole, string> store) : base(store)
        {
        }

        public static AppRoleManager Create(IdentityFactoryOptions<AppRoleManager> options, IOwinContext context)
        {
            var manager = new AppRoleManager(new RoleStore<AspNetRole>(context.Get<ApplicationDbContext>()));

            //manager.Roles.Provider;
    ...
    public class AppUserManager : UserManager<AppUser>
    {
        ...
        public static AppUserManager Create(IdentityFactoryOptions<AppUserManager> options, IOwinContext context)
        {
            ...
            // uses Phone and Emails as a step of receiving a code for verifying
